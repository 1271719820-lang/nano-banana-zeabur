...
// ==============================================
// 🔥 核心：修复 Zeabur 30秒断开 & 所有浏览器兼容
// ==============================================
// 1. 强制开启长连接，防止平台断开
app.use((req, res, next) => {
    res.setHeader('Connection', 'keep-alive');
    res.setHeader('Keep-Alive', 'timeout=600'); // 10分钟
...
server.timeout = 180000; // 3分钟超时，不会强制断开
server.keepAliveTimeout = 180000;

// ==============================================
// 配置 GRSAI (唯一提供商，最稳最便宜)
// ==============================================
const PROVIDERS = [
    {
        name: 'GRSAI',
        apiUrl: 'https://grsai.dakka.com.cn/v1/draw/nano-banana',
        apiKey: 'sk-a1c7ff1ce99f4e03a5aed5ddb82dce58', // 你的Key
        modelMapping: {
...
// ==============================================
// 🔥 核心生成接口 (同步模式，与前端路径完全一致 /api/generate)
// ==============================================
app.post('/api/generate', upload.array('images',3), async (req,res)=>{
    try{
        ...
        console.log('开始调用GRSAI:', provider.apiUrl);
